...
import type { PublicDictionary, PublicPost, PublicWord } from './types'

export async function getSyncedPosts(companyId: number): Promise<PublicPost[]> {
...
export async function getSyncedDictionaries(companyId: number): Promise<PublicDictionary[]> {
