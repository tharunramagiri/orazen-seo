  ...
  return (
    ...
    >
      ...
      {products.length > 0 ? (
        ...
        <div className="mt-6 rounded-md border-l-4 border-red-600 bg-red-500 p-4 text-white">
          This product recommendations component has not been populated yet. To do this, navigate to
          the eCommerce section by clicking{' '}
          <a href="/ecommerce" className="underline text-blue-200">
            here
          </a>{' '}
